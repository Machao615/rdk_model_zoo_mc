...
- RDK使用llama.cpp运行语言大模型: [D-Robotics 论坛](https://developer.d-robotics.cc/forumDetail/256524800871478519)
- llama.cpp: [GitHub](https://github.com/ggerganov/llama.cpp/blob/master/docs/build.md)
- GLM的部分模型: [HuggingFace](https://huggingface.co/THUDM/glm-edge-1.5b-chat-gguf/blob/main/README_zh.md)
...
如果是RWKV这种不带KV Cache的LLM，需要添加 `--no-context-shift` 参数：
